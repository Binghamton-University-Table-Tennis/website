...
class Matches(models.Model):
    ...
    Winner_Score = models.IntegerField(choices=[(x+1,x+1) for x in range(4)], help_text="Number of sets won")
    Loser_Score = models.IntegerField(choices=[(x,x) for x in range(4)], help_text="Number of sets won")
